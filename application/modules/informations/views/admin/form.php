...
<div class="page-content">
	...
	<div class="row-fluid">
		<div class="span12">
			<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" method="post" action="informations/admin/informations/save/<?php echo $rs->id ?>" enctype="multipart/form-data">
					...
					<div class="control-group">
			            ...
			            <div class="controls">
			                <?php if($rs->image):?>
			                <img class="img" style="width:100px;" src="<?php echo (is_file('uploads/informations/'.$rs->image))? 'uploads/informations/'.$rs->image : 'media/images/webboard/noavatar.gif' ?>"  /> <br><br>
			                <?php endif;?>
					...
					<div class="form-actions">
						...
						<button class="btn btn-large" type="reset">
							<i class="icon-undo bigger-110"></i>รีเซ็ต
                                                ...
                                                &nbsp; &nbsp; &nbsp;
						<a class="btn btn-large" href="informations/admin/informations" >กลับ</a>
					</div>

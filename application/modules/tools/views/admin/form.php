...
<div class="page-content">
	...
	<div class="row-fluid">
		<div class="span12">
			<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" method="post" action="tools/admin/tools/save/<?php echo $rs->id?>" enctype="multipart/form-data">
					...
					<div class="control-group">
			            ...
			            <div class="controls">
			                <?php if($rs->image):?>
			                <img class="img" style="width:100px;" src="<?php echo (is_file('uploads/tools/'.$rs->image))? 'uploads/tools/'.$rs->image : 'media/images/webboard/noavatar.gif' ?>"  /> <br><br>
			                <?php endif;?>
